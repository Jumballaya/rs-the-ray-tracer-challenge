/**
 *    RE-RENDER of the last chapter, this time added shadows
 *
 */
...
fn create_floor() -> Object {
    Object::new_sphere()
        ...
        .with_material(create_floor_mat())
}
...
fn main() -> std::io::Result<()> {
    ...
    world.add_object(create_left_wall());
    world.add_object(create_right_wall());
    ...
    world.render(&camera).save("./", "chapter8")
}
