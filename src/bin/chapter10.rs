/**
 *
 * Slight change of the Chapter 9 scene to add patterns
 *
 */
...
fn create_floor() -> Object {
    Object::new_plane().with_pattern(Pattern::new_checker(Color::black(), Color::white()))
}
...
fn create_right() -> Object {
    Object::new_sphere()
        ...
        .with_pattern(
            Pattern::new_stripe(Color::black(), Color::white())
...
fn main() -> std::io::Result<()> {
    ...
    world.render(&camera).save("./", "chapter10")
}
